...
const ANTHROPIC_API_KEY = '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';
const TWILIO_ACCOUNT_SID = 'AC198f9e80e97249ad432670260c21895b';
const TWILIO_AUTH_TOKEN = '183684feda1a3f14406d897aab314fac';
...
ORDERING: Direct to theunmuteateshharc.earth. For church/bulk orders (especially 16oz oils) invite them to contact via the website. Never invent prices.

TONE: Warm, spiritual, poetic but clear. Keep replies SHORT for WhatsApp - 2-3 sentences max. No markdown asterisks or bold. Sign off with a single line break then: Visit us: theunmuteateshharc.earth`;
...
const server = http.createServer(async (req, res) => {
  if (req.method === 'GET') {
    ...
    res.end('Esh-har Spirit Guide WhatsApp Bot is running! ✦ CGs Apothecary');
    return;
  }
